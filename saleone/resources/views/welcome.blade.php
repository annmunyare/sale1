			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<form action="/newsletter" method="post" class="wow fadeInUp" data-wow-delay="0.9s">
						{{ csrf_field() }}
			...
			<div class="container">
				<div class="row">
					...
					<div>
						...
						@endif
						<form action="contact" method="post" class="col-md-6 col-sm-4" id="contact-form" role="form">
							{{csrf_field()}}
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-5">
						<ul class="social-icon">
							...
							<li><a  href="mailto:annmunyare28@gmail.com?Subject=Hello%20again" target="_top" class="fa fa-google"></a></li>
